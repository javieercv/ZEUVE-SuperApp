...
python3 Scripts/check_social_engines.py Resources/Engines || {
  echo "Faltan gallery-dl o instaloader-zeuve. Ejecuta primero Scripts/prepare_social_engines_macos.sh Resources/Engines." >&2
  exit 1
}
