...
/// Snapshot compacto usado por una sesión real respaldada por SQLite. A diferencia del
/// snapshot histórico basado en arrays, no conserva copias de los mensajes en memoria.
public struct ChatStoreCoreAnalyticsSnapshot: Sendable, Equatable {
    public let totalMessages: Int
    public let filteredMessageCount: Int
    public let participantNames: [String]
    public let firstTimelineMessage: Date?
    public let lastTimelineMessage: Date?
    ...
    public init(
        ...
        firstTimelineMessage: Date?,
        lastTimelineMessage: Date?,
        summary: ChatSummaryStatistics
    ) {
        self.totalMessages = totalMessages
        self.filteredMessageCount = filteredMessageCount
        self.participantNames = participantNames
        self.firstTimelineMessage = firstTimelineMessage
        self.lastTimelineMessage = lastTimelineMessage
        self.summary = summary
    }

    public static let empty = ChatStoreCoreAnalyticsSnapshot(
        totalMessages: 0,
        filteredMessageCount: 0,
        participantNames: [],
        firstTimelineMessage: nil,
        lastTimelineMessage: nil,
        summary: .empty
    )
}
