...
public final class ChatArchiveReader: @unchecked Sendable {
    ...
    public func catalog(cancellation: @Sendable () -> Bool = { false }) throws -> ChatArchiveCatalog {
        ...
        try withArchive { archive in
            ...
            while true {
                ...
                guard seen.insert(path).inserted else {
                    throw ChatAnalyzerError.archiveUnsafe("entrada duplicada \(path)")
                }
    ...
    public func read(paths: Set<String>, maximumBytesPerEntry: Int64? = nil, cancellation: @Sendable () -> Bool = { false }) throws -> [String: Data] {
    ...
    public func readPrefixes(paths: Set<String>, maximumBytesPerEntry: Int64, cancellation: @Sendable () -> Bool = { false }) throws -> [String: Data] {
