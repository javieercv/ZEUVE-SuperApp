...
public enum UniversalDownloaderModuleDefinition {
    public static func manifest() throws -> ModuleManifest {
        ...
        #endif
        return try ModuleManifestLoader.load(from: url, missingResourceError: UniversalDownloaderError.invalidManifest)
    }
}
