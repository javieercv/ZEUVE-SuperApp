...
public struct DownloadWorkspace: Sendable, Equatable {
    ...
    public func verify(fileManager: FileManager = .default) throws {
        ...
        guard decoded.operationID == operationID,
            ...
            throw UniversalDownloaderError.invalidTemporaryWorkspace
        }
    }

    public func resetForRetry(fileManager: FileManager = .default) throws {
        try verify(fileManager: fileManager)
        for directory in [download, temporary, metadata] {
