...
public struct YTDLPProgressParser: Sendable {
    public init() {}

    public func parse(line: String, itemIndex: Int, itemTotal: Int, title: String, completed: Int, failed: Int, skipped: Int) -> UniversalDownloadProgress? {
        ...
        return UniversalDownloadProgress(
            phase: .downloading,
            currentItem: title,
            itemIndex: itemIndex,
            itemTotal: itemTotal,
    ...
    private func base(_ phase: DownloadProgressPhase, _ index: Int, _ total: Int, _ title: String, _ completed: Int, _ failed: Int, _ skipped: Int) -> UniversalDownloadProgress {
