...
public enum SHA256 {
    ...
    public static func hexDigest(data: Data) -> String {
        digest(data: data).map { String(format: "%02x", $0) }.joined()
    }

    public static func hexDigest(fileAt url: URL, chunkSize: Int = 1_048_576) throws -> String {
    ...
    private struct Incremental {
        ...
        mutating func finalize() -> [UInt8] {
            ...
            var bigEndian = bitCount.bigEndian
        ...
        mutating func process(_ block: Data.SubSequence) {
