...
var products: [Product] = [
    ...
    .library(name: "YouTubeDownloaderModule", targets: ["YouTubeDownloaderModule"]),
...
var targets: [Target] = [
    ...
    .target(
        name: "YouTubeDownloaderModule",
        dependencies: ["ZEUVECore", "ZEUVEStorage", "ZEUVEOperations", "ZEUVEEngines"],
        path: "Sources/YouTubeDownloaderModule",
        resources: [.process("Resources")]
    ),
    .target(
    ...
    .testTarget(
        name: "YouTubeDownloaderModuleTests",
        dependencies: ["YouTubeDownloaderModule", "ZEUVEEngines", "ZEUVEStorage", "ZEUVECore"],
        path: "Tests/YouTubeDownloaderModuleTests"
    ),
    .testTarget(
