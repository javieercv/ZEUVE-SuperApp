...
Esta carpeta separa la documentación **vigente** —la que se consulta para diseñar, desarrollar, validar y mantener ZEUVE 0.20.5.0— de las evidencias **históricas** de cada entrega. Empieza aquí para localizar la fuente adecuada sin recorrer el historial.
...
Evidencia de la entrega actual: [implementación](Historico/Implementacion/IMPLEMENTATION_REPORT_0.20.5.0.md), [pruebas](Historico/Pruebas/TEST_RESULTS_0.20.5.0.md) y [entrega](Historico/Entregas/DELIVERY_0.20.5.0.md).
